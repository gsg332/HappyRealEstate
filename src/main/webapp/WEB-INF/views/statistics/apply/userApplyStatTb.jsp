...
<script type="text/javascript">
	$(document).ready(function(){
        ...
        if('${allList[3]}' != 0)
        {
		    var pieValue = [['해결활용',<fmt:formatNumber value="${allList[4] / allList[3] * 100}" pattern=".0" />], ['미활용',<fmt:formatNumber value="${allList[5] / allList[3] * 100}" pattern=".0" />]];
		       
		    var plot = $.jqplot('userPieChart', [pieValue], {
		...
		<div class="panel panel-default" style="margin-top:10px">
			...
			<div class="panel-footer" style="background:(url../../resources/images/th.gif); height:250px">
				<div id="userPieChart" style="height:240px"></div>
			</div>
			...
			<div class="panel-body">
				<table class="table table-striped table_b text-center">
					...
					<tbody>
						...
						<!-- tr>
							<td colspan="3" class="white text-right">
