...
<script type="text/javascript">
	var crimeMarkerList = new Array();
	
	$(document).ready(function(){
	
		<c:forEach var="marker" items="${crimeMarkerList}" varStatus="status">
			var marker = new Object();
			marker['imageSrc'] = '${marker.imageSrc}';
			marker['itemLatitude'] = '${marker.itemLatitude}';
			marker['itemLongitude'] = '${marker.itemLongitude}';
			marker['itemType'] = '${marker.itemType}';
			marker['code2'] = '${marker.code2}';
			crimeMarkerList.push(marker)
		</c:forEach>
		...
		$("input[name=crimeTypeUnit]").change(function(){
			searchTypeStatList($(this).val());
							...
							<div class="btn-group mapbtn1" data-toggle="buttons">
								...
								<button type="button" class="btn btn-default" style="background:#fff;width: 43px; height: 27px;" onclick="exportExcel('/map/type/addr3statInfoExcel.do')" alt="엑셀다운로드" title="엑셀다운로드">
							...
							<div style="height:269px; overflow:auto">
								<table class="table table-hover text-center">
									<tbody>
										<tr>
											<td width="10%">${typeStatInfo.locationDong}</td>
