 ...
 *  @fileName : CctvInstAddr2StatInfoExcelView.java
 *  @author : jincheol
 *  @since 2016. 10. 13.
 *  @version 1.0 
 *  @see  :  
 ...
 *    DATE	           NAME			DESC
 *     -----------	 ----------   ---------------------------------------
 *     2016. 10. 13.   jincheol       create CctvInstAddr2StatInfoExcelView.java
 *  </pre>
 ******************************************************************************/
public class CctvInstAddr2StatInfoExcelView extends ExcelView{
	...
	protected void createData(Map<String,Object> model) {
		...
		if (mapStatDto == null){
			...
			for (int i=0; i<5; i++){
				...
				if (i == 0) {
					cell = row.createCell(0);
					cell.setCellValue(mapStatDto.getLocationGu());
					cell.setCellStyle(style);
